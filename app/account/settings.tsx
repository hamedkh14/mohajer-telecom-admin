...
const Settings = () => {
  ...
  const [numberCardName, setNumberCardName] = useState("");
      ...
      >
        <ScrollView>
          ...
          >
            <Input
              numeric
              label="قیمت هر افغانی به تومان"
              value={afghaniToToman}
              onChangeText={(text) => setAfghaniToToman(text)}
            />
            <Input
              numeric
              label="قیمت هر افغانی به تومان (حواله)"
              value={remittancePrice}
              onChangeText={(text) => setRemittancePrice(text)}
            />
            <Input
              label="قیمت حواله برای نمایش به مشتری"
              value={remittancePriceText}
              onChangeText={(text) => setRemittancePriceText(text)}
            />
            <Input
              label="شماره کارت"
              numeric
            ...
            <Input
              label="نام صاحب کارت"
              value={numberCardName}
              onChangeText={(text) => setNumberCardName(text)}
            />
            <Input
              label="شماره واتساپ پشتیبانی"
              numeric
              value={whatsappPhoneNumber}
              onChangeText={(text) => setWhatsappPhoneNumber(text)}
            />
            <Input
              label="لیست شهرها"
              multiline
              value={remittanceCities}
              onChangeText={(text) => setRemittanceCities(text)}
            />
            <Button
              text={"ثبت"}
