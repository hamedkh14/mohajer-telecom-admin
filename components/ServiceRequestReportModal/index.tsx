...
const ServiceRequestReportModal = ({data, open, onClose, confirmOpen}: modalProp) => {
              ...
              data?.type === 'uc-pubg' ? (
                <>
                  <View style={styles.item}>
                    ...
                    <ThemedText type='text'>{data?.information.accountName}</ThemedText>
                  </View>
                  <View style={styles.item}>
                    <ThemedText type='caption' style={{fontSize: 16}}>آیدی اکانت:</ThemedText>
                    <ThemedText type='text'>{data?.information.accountId}</ThemedText>
                  </View>
                </>
